"""
This program simulates a word suggestion search engine by providing user with a list of possible words based on user input.
The user will be prompt to create their desired Trie structure and they have the option to get suggestions for the characters/words they type
